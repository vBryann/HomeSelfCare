...
class Progress: UIView {
    ...
    let cardWater : CardView = {
        ...
        // icons
        card.imageView.image = #imageLiteral(resourceName: "Icon ionic-ios-water")
        ...
        card.animatedCircle.duration = 1
    ...
    let cardFood : CardView = {
        ...
        // icons
        card.imageView.image = #imageLiteral(resourceName: "Group 89")
    ...
    let cardSteps : CardView = {
           ...
           // icons
        card.imageView.image = #imageLiteral(resourceName: "Icon awesome-running")
    ...
    let cardBlaze : CardView = {
        ...
        // icons
     card.imageView.image = #imageLiteral(resourceName: "Group 95")
    ...
    let cardSleep : CardView = {
        ...
        // icons
     card.imageView.image = #imageLiteral(resourceName: "Grupo 777")
    ...
    let cardStand : CardView = {
        ...
        // icons
     card.imageView.image = #imageLiteral(resourceName: "Icon ionic-ios-man")
